...
typedef DWORD(WINAPI * t_OutputDebugStringW)(LPCWSTR lpOutputString); //Kernel32.dll0
//WIN 7 X64: OutputDebugStringW -> OutputDebugStringA

typedef HANDLE(WINAPI* t_CreateProcessA)(
...
typedef HANDLE(WINAPI* t_CreateProcessW)(
    LPCWSTR lpApplicationName,						// 可执行模块名称
...
typedef struct _HOOK_DLL_DATA {
	...
	BOOLEAN EnableCreateProcessAHook;
	BOOLEAN EnableCreateProcessWHook;
	...
	/////////////////////////////////////////////////////////
    t_CreateProcessA dCreateProcessA;
    t_CreateProcessW dCreateProcessW;
    DWORD CreateProcessABackupSize;
    DWORD CreateProcessWBackupSize;
