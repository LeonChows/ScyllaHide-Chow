...
const WCHAR g_scyllaHideDllFilename[] = L"HookLibraryx64.Chow";
    ...
    case dbg_process_start:
    {
        ...
        if (dbg != nullptr)
        {
            ...
            if (dbg->is_remote())
            {
                ...
                get_process_options(NULL, NULL, NULL, NULL, &hoststring, NULL, NULL);
...
static bool idaapi IDAP_run(std::size_t arg)
{
...
static plugmod_t* idaapi IDAP_init(void)
{
    ...
    if (inf_get_filetype() != f_PE) return PLUGIN_SKIP;
...
static char IDAP_hotkey[] = "Ctrl-Alt-X";
