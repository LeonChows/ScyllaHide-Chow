...
void scl::Settings::LoadProfile(const wchar_t *file, const wchar_t *name, Profile *profile)
{
    ...
    profile->hookCreateProcessA = IniLoadNum(file, name, L"CreateProcessA", 1);
    profile->hookCreateProcessW = IniLoadNum(file, name, L"CreateProcessW", 1);
...
bool scl::Settings::SaveProfile(const wchar_t *file, const wchar_t *name, const Profile *profile)
{
    ...
    success &= IniSaveNum(file, name, L"CreateProcessA", profile->hookCreateProcessA);
    success &= IniSaveNum(file, name, L"CreateProcessW", profile->hookCreateProcessW);
